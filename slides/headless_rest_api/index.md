# Headless CMS Concept with eZ Platform

<center><small>M.Sc. Ramzi Arfaoui</small></center>

<center><small>Ez Systems Cologne</small></center>
...
- Building Apps using REST and GraphQL
...
<center><img src="img/ez-platform-architecture.png"></center>
...
<center><img src="img/3rd_party_integration.png"></center>

--

## eZ Commerce - best candidate extension

<center><img src="img/ez_commerce.png"></center>

--

## REST API for Apps

<center><img src="img/apps.png"></center>
...
- REST::doc <img style="width: 90px; height: 40px; position: relative; top: 20px;" src="img/eZ-Logo.svg" />
  - https://doc.ezplatform.com/en/2.0/api/extending_the_rest_api/

--

https://learning.ezplatform.com/Headless-CMS-Concepts

<center><img src="img/e-learning_headless.png"></center>
...
- RESTful API
- Public PHP API
- [eZ-Migration Bundle](https://github.com/kaliop-uk/ezmigrationbundle)
- [GraphQL](https://github.com/bdunogier/ezplatform-graphql-bundle)
...
$contentCreateStruct = $contentService->newContentCreateStruct('article', 'eng-GB');
...
- [eZ CookBook](https://github.com/ezsystems/CookbookBundle/tree/master/Command)
- [ContentFieldTypes list](https://gist.github.com/arfaram/e21c1950fe6e1a46d70e7873b103ba72#file-createezcontentfieldtypescommand-php)
...
#### GraphQL - query (Load locationChildren Content)

<center><img src="img/graphql_request.png"></center>
...
#### GraphQL - query (Load locationChildren urlAliases)

<center><img src="img/graphql_request_urlaliases.png"></center>
